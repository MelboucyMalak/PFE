...
def Cropselect(ph, soil_texture, rainfall, temperature, humedity, koppen):
    ...
    return Crop.objects.filter(
        cropclimate_set__climate__climate_zone=koppen,
        ...
        cropsoiltexture_set__soil_texture__texture_class=soil_texture,
        ...
        'crop_name',
        'cropclimate_set__climate__climate_zone',
        'cropsoiltexture_set__soil_texture__texture_class'
    ).distinct()
