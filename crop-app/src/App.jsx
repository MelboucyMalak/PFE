...
import { FarmerDashboard, CropConsultingIntro, CropsConsulting, RecommendationsHistory, FarmerProfile, MapComponent } 
from './pages/farmer'
      ...
      <Routes>
        ...
        <Route path="/farmer"> 
          ...
          <Route path="crops-consulting">
            <Route index element={<CropConsultingIntro />} />
            <Route path="list" element={<CropsConsulting />} />
            <Route path=":cropId" element={<CropDetail />} />
          </Route>
