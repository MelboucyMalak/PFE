...
Grow Your Future</p>
        <p className={styles.heroDescription}>Torbati gives you personalized crop recommendations based on your soil, climate and region — so you can farm smarter, not harder.</p>
