...
async function run() {
  ...
  try {
    ...
    const updatedCropReco = list2[0];
    console.log("Crop recommendation item keys after field analysis:", Object.keys(updatedCropReco));
    console.log("Crop recommendation item content after field analysis:", JSON.stringify(updatedCropReco, null, 2));
